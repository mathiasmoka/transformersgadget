...
graph TD
    ...
    A -->|Crossbar Frame Lock| C(Portable Chair Mode)
    A -->|Full Exoskeleton Unfold| D(Emergency Tent Mode)
    
    style A fill:#1c2333,stroke:#e8ff47,stroke-width:2px,color:#fff
